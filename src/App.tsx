...
export default function App() {
  const [currentView, setCurrentView] = useState<'dashboard' | 'chapter-1' | 'chapter-2'>('dashboard');

  return (
    <div className="min-h-screen bg-transparent py-8 selection:bg-yellow-300">
      {currentView === 'dashboard' && (
        <Dashboard onSelectChapter={(id) => setCurrentView(id as 'chapter-1' | 'chapter-2')} />
      )}
